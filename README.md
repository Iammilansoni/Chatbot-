# Coal-india-chatbot (Act Master)
A chatbot to respond to text queries pertaining to various acts, rules and regulations applicable to mining industries.


## Local Deployment
1. Make an empty folder and cd into it then -> git clone iitmandi-health-api<br>
`git@github.com:feignbird/coal-india-chatbot.git`

2. Create an Virtual Environment <br>
`python3 -m venv env` <br>
`source env/bin/activate` <br>

3. Install required python packages <br>
    `pip install -r requirements.txt` <br>
    (might have to comment out psycopg2==2.9.3 on mac and use pip install psycopg2-binary==2.9.3) <br>

4. `cp example.env .env` & fill all the info.

5. `cp actmaster/sample_local_settings.py actmaster/local_settings.py` & fill local_settings.py (if required)
